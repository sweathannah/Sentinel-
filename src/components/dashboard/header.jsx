...
function Header() {
  ...
  const fetchUserCredential = async () => {
    ...
    return (
        <header className="lg:px-[1.9rem] px-[1.25rem] bg-[#F8F8F8] py-[2rem] font-poppins flex flex-row justify-between w-full">
            <div className="flex flex-col">
                <h1 className="text-[#000000] font-semibold text-[1.5rem]">
                    Hello, 
                    {!userDetails && <span className=" mx-2">
                    ...
                    <span className="mx-2">{userDetails && userDetails?.first_name}</span>
                </h1>

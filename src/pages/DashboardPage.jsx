  ...
  console.log('user logged in')
    return (
      <section className="flex flex-col px-[2rem] gap-[1.5rem] bg-[#F7F7F7]">
        <article className="flex flex-row flex-wrap justify-between">
          <div className="bg-[#FFFFFF] lg:min-w-[21.5rem] min-w-[25.5rem] flex flex-col items-start p-[1rem] border-[2px] border-solid border-[#DDDDDD] shadow-lg rounded-xl hover:bg-gradient-to-r hover:from-[#B42318] hover:to-[#A80000] hover:text-[#F7F7F7] text-[#000000] transform hover:scale-[1.03] hover:shadow-2xl transition-all duration-300 ease-in-out cursor-pointer"> 
          ...
          <div className="bg-[#FFFFFF] lg:min-w-[21.5rem] min-w-[25.5rem] flex flex-col items-start p-[1rem] border-[2px] border-solid border-[#DDDDDD]    shadow-lg rounded-lg hover:bg-gradient-to-r hover:from-[#B42318] hover:to-[#A80000] hover:text-[#F7F7F7] text-[#000000] transform hover:scale-[1.03] hover:shadow-2xl transition-all duration-300 ease-in-out cursor-pointer">
          ...
          <div className="bg-[#FFFFFF] flex flex-col lg:min-w-[21.5rem] min-w-[25.5rem] items-start p-[1rem] border-[2px] border-solid border-[#DDDDDD] shadow-lg rounded-lg hover:bg-gradient-to-r hover:from-[#B42318] hover:to-[#A80000] hover:text-[#F7F7F7] text-[#000000] transform hover:scale-[1.03] hover:shadow-2xl transition-all duration-300 ease-in-out cursor-pointer">
        ...
        <article className="flex flex-row gap-[1rem]">
          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-row flex-wrap gap-[1rem]">
              <div className="p-[1rem] bg-[#FFFFFF] flex flex-col items-start border-[2px] border-solid border-[#DDDDDD] h-fit shadow-sm rounded-lg min-w-[10rem]">
              ...
              <div className="p-[1rem] bg-[#FFFFFF] flex flex-col items-start border-[2px] border-solid border-[#DDDDDD]  shadow-sm h-fit rounded-lg min-w-[10rem]">
              ...
              <div className="p-[1rem] bg-[#FFFFFF] flex flex-col items-start border-[2px] border-solid border-[#DDDDDD] shadow-sm rounded-lg h-fit min-w-[10rem]">
          ...
          {/* LIVE ALERTS */}
          <div className="bg-[#FFFFFF] rounded-[0.5rem] py-[1.34rem] px-[1.5rem] shadow-sm flex flex-col w-[50%] gap-[0.75rem]">

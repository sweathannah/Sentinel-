...
function AuthPage() {
    ...
    return (
        <section className="min-h-screen flex flex-col items-start justify-center bg-[#F8F8F8] px-[1.25rem] font-poppins">
            <Header/>
            <div className="flex flex-col items-stretch mx-auto justify-center md:flex-row bg-white rounded-[1.5rem] shadow-lg p-6 md:p-12 max-w-5xl w-full gap-[1rem]">
